...
\begin{document}
    ...
    \begin{enumerate}
        \item Talk about deepchess
        \item Talk about MaiaChess (optional)
        \item Talk about LeelaChess (optional)
        \item Talk about AlphaZero (optional)
    \end{enumerate}

    \subsection{Parsing Chess Data}

    \begin{enumerate}
        \item Talk about reading PGN 
        \item Talk about converting PGN into FEN
        \item Talk about converting FEN into proper input (numbers)
    \end{enumerate}
    ...
    \begin{enumerate}
        \item Talk about ReLU for autoencoder 
