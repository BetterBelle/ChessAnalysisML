...
\begin{document}
    ...
    We will be creating a script that will extract the PGN data shown above and store into DB using this structure. 
    \begin{table}[ht]
    \centering
    ...
    Once the data has been submitted to our database, we can then further process each Chess game using our implementation of the machine learning algorithm.   
    \newpage
    \printbibliography
\end{document}